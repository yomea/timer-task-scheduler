package com.hangu.task.config;

import com.hangu.task.properties.RedissonProperty;
import com.hangu.task.utils.RedissonLock;
...
public class RedisConfig {
    ...
    public JedisSentinelPool jedisSentinelPool(JedisPoolConfig jedisPoolConfig) {
        ...
        return new JedisSentinelPool(redissonProperty.getMaster(), infos, jedisPoolConfig, 5000, redissonProperty.getPassword());
    }
    ...
    @Bean
    public RedissonLock redisLock(RedissonClient redissonClient) {
