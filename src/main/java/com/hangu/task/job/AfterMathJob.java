...
public class AfterMathJob {
    ...
    public void checkNeedRetryTask() {
        ...
        String lock = "com.hangu.task.job.AfterMathJob.checkNeedRetryTask";
    ...
    public void checkDownLineTask() {
        ...
        String lock = "com.hangu.task.job.AfterMathJob.checkDownLineTask";
    ...
    public void cleanOldTaskUpdateMsg() {
        ...
        String lock = "com.hangu.task.job.AfterMathJob.cleanOldTaskUpdateMsg";
