...
CREATE TABLE shinemo_im.smt_ts_task_lock (
...
create unique index on shinemo_im.smt_ts_task_lock(smc_def_id);

CREATE TABLE shinemo_im.smt_ts_task_def (
  id BIGSERIAL NOT NULL PRIMARY KEY,
  gmt_create timestamp NOT NULL ,
  gmt_modified timestamp DEFAULT NULL ,
  smc_def_pid bigint DEFAULT '-1' ,
...
create unique index on shinemo_im.smt_ts_task_def(smc_customer_id,app_service_name,api_service_name,api_method_name);
create index on shinemo_im.smt_ts_task_def(smc_top_pid);

CREATE TABLE shinemo_im.smt_ts_task_timer (
  id BIGSERIAL NOT NULL PRIMARY KEY,
  gmt_create timestamp NOT NULL ,
  gmt_modified timestamp DEFAULT NULL ,
  smc_def_id bigint NOT NULL ,
...
create index on shinemo_im.smt_ts_task_timer(smc_def_id,smc_start_day,smc_end_day);

-- 月表 smt_ts_task_record_202110 smt_ts_task_record_202111
CREATE TABLE shinemo_im.smt_ts_task_record (
  id BIGSERIAL NOT NULL PRIMARY KEY,
  gmt_create timestamp NOT NULL ,
  gmt_modified timestamp DEFAULT NULL ,
...
create index on shinemo_im.smt_ts_task_record(smc_def_id);


CREATE TABLE shinemo_im.smt_ts_task_msg (
  id BIGSERIAL NOT NULL PRIMARY KEY,
  gmt_create timestamp NOT NULL ,
  gmt_modified timestamp DEFAULT NULL ,
  smc_def_id bigint NOT NULL ,
...
create unique index on shinemo_im.smt_ts_task_msg(id,gmt_create);
create index  on shinemo_im.smt_ts_task_msg(gmt_create);
create index on shinemo_im.smt_ts_task_msg(smc_def_id);


CREATE TABLE shinemo_im.smt_ts_consume_progress (
  id BIGSERIAL NOT NULL PRIMARY KEY,
  gmt_create timestamp NOT NULL ,
  gmt_modified timestamp DEFAULT NULL ,
...
create unique index on shinemo_im.smt_ts_consume_progress(smc_ip);
